...
user_iram_end = (0x20000 - ((0x3ffe5400) - 0x3ffe0000) + 0x400a0000);
...
user_dram_2_seg_org = 0x3ffe5400;
user_dram_2_seg_len = (0x40000000 - 0x3ffe5400);
MEMORY
{
 ...
 *(.rela.*)
 ...
 net_if_area : ALIGN_WITH_INPUT SUBALIGN(4) { _net_if_list_start = .; KEEP(*(SORT_BY_NAME(._net_if.static.*))); _net_if_list_end = .; } > dram0_0_seg AT > FLASH net_if_dev_area : ALIGN_WITH_INPUT SUBALIGN(4) { _net_if_dev_list_start = .; KEEP(*(SORT_BY_NAME(._net_if_dev.static.*))); _net_if_dev_list_end = .; } > dram0_0_seg AT > FLASH net_l2_area : ALIGN_WITH_INPUT SUBALIGN(4) { _net_l2_list_start = .; KEEP(*(SORT_BY_NAME(._net_l2.static.*))); _net_l2_list_end = .; } > dram0_0_seg AT > FLASH eth_bridge_area : ALIGN_WITH_INPUT SUBALIGN(4) { _eth_bridge_list_start = .; KEEP(*(SORT_BY_NAME(._eth_bridge.static.*))); _eth_bridge_list_end = .; } > dram0_0_seg AT > FLASH
         
 log_strings_area : ALIGN_WITH_INPUT SUBALIGN(4) { _log_strings_list_start = .; KEEP(*(SORT_BY_NAME(._log_strings.static.*))); _log_strings_list_end = .; } > dram0_0_seg AT > FLASH
 log_const_area : ALIGN_WITH_INPUT SUBALIGN(4) { _log_const_list_start = .; KEEP(*(SORT_BY_NAME(._log_const.static.*))); _log_const_list_end = .; } > dram0_0_seg AT > FLASH
 log_backend_area : ALIGN_WITH_INPUT SUBALIGN(4) { _log_backend_list_start = .; KEEP(*(SORT_BY_NAME(._log_backend.static.*))); _log_backend_list_end = .; } > dram0_0_seg AT > FLASH
 log_link_area : ALIGN_WITH_INPUT SUBALIGN(4) { _log_link_list_start = .; KEEP(*(SORT_BY_NAME(._log_link.static.*))); _log_link_list_end = .; } > dram0_0_seg AT > FLASH
 ...
 device_area : ALIGN_WITH_INPUT SUBALIGN(4) { _device_list_start = .; KEEP(*(SORT(._device.static.*_?_*))); KEEP(*(SORT(._device.static.*_??_*))); _device_list_end = .; } > drom0_0_seg AT > FLASH
 ...
 k_p4wq_initparam_area : ALIGN_WITH_INPUT SUBALIGN(4) { _k_p4wq_initparam_list_start = .; KEEP(*(SORT_BY_NAME(._k_p4wq_initparam.static.*))); _k_p4wq_initparam_list_end = .; } > drom0_0_seg AT > FLASH
 _static_thread_data_area : ALIGN_WITH_INPUT SUBALIGN(4) { __static_thread_data_list_start = .; KEEP(*(SORT_BY_NAME(.__static_thread_data.static.*))); __static_thread_data_list_end = .; } > drom0_0_seg AT > FLASH
...
ztest : ALIGN_WITH_INPUT
{
 ...
 net_socket_register_area : ALIGN_WITH_INPUT SUBALIGN(4) { _net_socket_register_list_start = .; KEEP(*(SORT_BY_NAME(._net_socket_register.static.*))); _net_socket_register_list_end = .; } > drom0_0_seg AT > FLASH
 http_service_desc_area : ALIGN_WITH_INPUT SUBALIGN(4) { _http_service_desc_list_start = .; KEEP(*(SORT_BY_NAME(._http_service_desc.static.*))); _http_service_desc_list_end = .; } > drom0_0_seg AT > FLASH
 net_mgmt_event_static_handler_area : ALIGN_WITH_INPUT SUBALIGN(4) { _net_mgmt_event_static_handler_list_start = .; KEEP(*(SORT_BY_NAME(._net_mgmt_event_static_handler.static.*))); _net_mgmt_event_static_handler_list_end = .; } > drom0_0_seg AT > FLASH
 net_socket_service_desc_area : ALIGN_WITH_INPUT SUBALIGN(4) { _net_socket_service_desc_list_start = .; KEEP(*(SORT_BY_NAME(._net_socket_service_desc.static.*))); _net_socket_service_desc_list_end = .; } > drom0_0_seg AT > FLASH
 bt_l2cap_fixed_chan_area : ALIGN_WITH_INPUT SUBALIGN(4) { _bt_l2cap_fixed_chan_list_start = .; KEEP(*(SORT_BY_NAME(._bt_l2cap_fixed_chan.static.*))); _bt_l2cap_fixed_chan_list_end = .; } > drom0_0_seg AT > FLASH
 bt_gatt_service_static_area : ALIGN_WITH_INPUT SUBALIGN(4) { _bt_gatt_service_static_list_start = .; KEEP(*(SORT_BY_NAME(._bt_gatt_service_static.static.*))); _bt_gatt_service_static_list_end = .; } > drom0_0_seg AT > FLASH
 tracing_backend_area : ALIGN_WITH_INPUT SUBALIGN(4) { _tracing_backend_list_start = .; KEEP(*(SORT_BY_NAME(._tracing_backend.static.*))); _tracing_backend_list_end = .; } > drom0_0_seg AT > FLASH
 ...
 shell_area : ALIGN_WITH_INPUT SUBALIGN(4) { _shell_list_start = .; KEEP(*(SORT_BY_NAME(._shell.static.*))); _shell_list_end = .; } > drom0_0_seg AT > FLASH
 shell_root_cmds_area : ALIGN_WITH_INPUT SUBALIGN(4) { _shell_root_cmds_list_start = .; KEEP(*(SORT_BY_NAME(._shell_root_cmds.static.*))); _shell_root_cmds_list_end = .; } > drom0_0_seg AT > FLASH
 shell_subcmds_area : ALIGN_WITH_INPUT SUBALIGN(4) { _shell_subcmds_list_start = .; KEEP(*(SORT_BY_NAME(._shell_subcmds.static.*))); _shell_subcmds_list_end = .; } > drom0_0_seg AT > FLASH
 shell_dynamic_subcmds_area : ALIGN_WITH_INPUT SUBALIGN(4) { _shell_dynamic_subcmds_list_start = .; KEEP(*(SORT_BY_NAME(._shell_dynamic_subcmds.static.*))); _shell_dynamic_subcmds_list_end = .; } > drom0_0_seg AT > FLASH
 cfb_font_area : ALIGN_WITH_INPUT SUBALIGN(4) { _cfb_font_list_start = .; KEEP(*(SORT_BY_NAME(._cfb_font.static.*))); _cfb_font_list_end = .; } > drom0_0_seg AT > FLASH

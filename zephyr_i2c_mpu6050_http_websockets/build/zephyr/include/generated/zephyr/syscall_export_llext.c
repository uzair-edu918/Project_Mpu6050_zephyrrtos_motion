 ...
 */
extern __weak ALIAS_OF(no_handler) void * const z_impl_xtensa_user_fault;
...
extern __weak ALIAS_OF(no_handler) void * const z_impl_net_eth_get_ptp_clock_by_index;
